...
function ScoreFinal(props) {
  ...
  switch (true) {
    ...
    default:
      Texte = (
        <div>
          Ne désespère pas <span className='colorBlue'>{pseudo}!</span>,
          continue de t'entrainer pour te classer dans le <b>TOP 100</b>!
        </div>
      );
      background = "backRed";
      break;
        ...
        <div className='ScoreFinal'>
          <div className='header'>
            ...
            <div className='note-container'>
              <span className={`note ${couleur}`}>{goodReponse}</span> /
              {maxQuestions}
            </div>
          </div>
